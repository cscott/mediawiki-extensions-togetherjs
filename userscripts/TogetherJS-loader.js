...
importScript( 'User:cscott/TogetherJS-ext.js');
if (window.TOGETHERJS_BETA) {
	importScript( 'User:cscott/TogetherJS-ext-ve.js');
}
...
(function () {
  ...
  var baseUrl = "//togetherjs.wmflabs.org/extensions/TogetherJS/togetherjs";
  ...
  var defaultHubBase = "https://togetherjs-hub.wmflabs.org";
